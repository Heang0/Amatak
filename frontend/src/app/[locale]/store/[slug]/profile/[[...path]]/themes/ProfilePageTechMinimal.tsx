  ...
  switch (themeStyle) {
    ...
    case 'default':
      return {
        ...
        case 'tech-minimal':
      return {
        bg: 'bg-[#050505] dark:bg-[#050505] font-sans text-gray-100',
        container: 'max-w-5xl',
        header: 'py-8 border-b border-[#333] mb-8',
        title: 'text-xl sm:text-2xl font-black uppercase tracking-widest text-gray-100',
        card: 'bg-black border border-[#333] p-6 md:p-8 rounded-none shadow-[0_0_15px_rgba(0,255,204,0.1)]',
        input: 'w-full px-4 py-3 bg-transparent border border-[#333] focus:outline-none focus:border-[#00FFcc] rounded-none text-sm text-[#00FFcc] shadow-[0_0_10px_rgba(0,255,204,0.1)]',
        label: 'block text-xs font-bold uppercase tracking-wider text-gray-400 mb-2',
        buttonPrimary: 'w-full py-3.5 px-4 font-black text-center transition-all mt-4 text-[#00FFcc] bg-[#00FFcc]/10 uppercase tracking-[0.2em] rounded-none border border-[#00FFcc] hover:bg-[#00FFcc]/20 shadow-[0_0_15px_rgba(0,255,204,0.4)]',
        buttonSecondary: 'inline-block font-bold px-6 py-2.5 text-xs uppercase tracking-widest transition-all border border-[#333] text-gray-400 rounded-none hover:border-[#00FFcc] hover:text-[#00FFcc]',
        buttonDanger: 'inline-block font-bold px-6 py-2.5 text-xs uppercase tracking-widest transition-all text-red-500 border border-red-500/50 hover:bg-red-500/10 rounded-none',
        tableHeader: 'border-b border-[#333]',
        tableCell: 'px-4 py-4 text-sm font-medium border-b border-[#222]',
        navTab: 'flex items-center gap-3 w-full p-4 font-bold text-gray-400 hover:text-[#00FFcc] hover:bg-[#00FFcc]/5 uppercase tracking-widest rounded-none mb-1 text-sm border-l-2 border-transparent hover:border-[#00FFcc]',
      };
...
export default function ProfilePageTechMinimal({ params }: { params: { slug: string, locale: string, path?: string[] } }) {
