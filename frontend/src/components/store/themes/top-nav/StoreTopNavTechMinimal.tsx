...
export default function StoreTopNavTechMinimal({ storeName, storeLogo, primaryColor, slug, locale, initialThemeStyle }: {
  storeName: string;
  storeLogo?: string;
  primaryColor: string;
  slug: string;
  ...
  } else if ('tech-minimal' === 'neo-brutalism') {
  ...
  } else if ('tech-minimal' === 'fashion-editorial' || 'tech-minimal' === 'minimalist') {
