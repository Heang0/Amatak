...
export default function StoreTopNavNeoBrutalism({ storeName, storeLogo, primaryColor, slug, locale, initialThemeStyle }: {
  storeName: string;
  storeLogo?: string;
  primaryColor: string;
  slug: string;
  ...
  } else if ('neo-brutalism' === 'fashion-editorial' || 'neo-brutalism' === 'minimalist') {
