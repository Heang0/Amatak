...
// --- THEME: TECH MINIMAL ---
  // -------------------------------------------------------------
  return (
    <div className="flex flex-col min-h-full bg-[#050505] dark:bg-[#050505] text-gray-100 transition-colors pb-24 md:pb-16">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between border-b border-[#333]">
        <button
          onClick={() => router.back()}
          className="p-1.5 -ml-1 text-gray-400 hover:text-[#00FFcc] transition-colors"
          title={text.goBack}
        >
          <ArrowLeft size={20} />
        </button>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <ShoppingBag size={20} />
            {totalCartItems > 0 && (
              <span className="absolute -top-0.5 -right-0.5 min-w-[15px] h-[15px] px-1 bg-transparent border border-[#00FFcc] text-[#00FFcc] shadow-[0_0_10px_rgba(0,255,204,0.3)] text-[8px] font-bold rounded-none flex items-center justify-center" style={{ backgroundColor: primaryColor || undefined }}>
                {totalCartItems}
              </span>
            )}
          </button>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-6 flex flex-col gap-3">
            <div className="w-full aspect-square bg-black border border-[#222] rounded-none relative overflow-hidden group border border-gray-200 dark:border-white/[0.08]">
          ...
          <div className="lg:col-span-6 flex flex-col">
            ...
            {/* Title & Price */}
            <div className="pb-4 mb-4 border-b border-[#333]">
              <h1 className="text-lg sm:text-xl font-bold uppercase tracking-wider text-gray-100 mb-2 leading-tight">
                {productTitle}
              </h1>
            ...
            {product.variants && product.variants.length > 0 && (
              <div className="space-y-5 pb-6 border-b border-[#333]">
                            ...
                            <button
                              ...
                              className={`min-w-[48px] h-10 px-3 flex items-center justify-center text-xs font-bold uppercase tracking-wider transition-all border rounded-none ${
                                isSelected
                                  ...
                                  : 'bg-white dark:bg-transparent text-gray-100 border-gray-200 dark:border-white/20 hover:border-gray-900 dark:hover:border-white'
                              }`}
                            >
                              {opt}
                            </button>
            ...
            <div className="py-6 space-y-3">
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className={`flex-1 h-11 bg-[#00FFcc]/20 hover:bg-[#00FFcc]/40 text-[#00FFcc] text-sm font-black tracking-[0.2em] uppercase border border-[#00FFcc] shadow-[0_0_15px_rgba(0,255,204,0.5)] transition-all flex items-center justify-center gap-2 active:scale-98 rounded-none`}
                  style={{ color: primaryColor || '#00FFcc', borderColor: primaryColor || '#00FFcc' }}
                >
                  <ShoppingBag size={14} />
            ...
            <div className="border-t border-gray-200 dark:border-white/[0.08] divide-y divide-gray-100 dark:divide-white/[0.06]">
              ...
              <div className="py-3.5">
                <button
                  ...
                  className={`w-full flex items-center justify-between text-xs font-bold ${isKm ? 'tracking-normal' : 'uppercase tracking-wider'} text-gray-100 text-left`}
                >
      ...
      {relatedProducts.length > 0 && (
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 border-t border-[#333]">
          <h2 className={`text-xs sm:text-sm font-bold ${isKm ? 'tracking-normal' : 'uppercase tracking-widest'} text-gray-100 mb-6`}>
