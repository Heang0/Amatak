...
export default function StoreTopNavSkincareClean({ storeName, storeLogo, primaryColor, slug, locale, initialThemeStyle }: {
  storeName: string;
  storeLogo?: string;
  primaryColor: string;
  slug: string;
  ...
  const [themeStyle, setThemeStyle] = useState('skincare-clean');
  ...
  } else if ('skincare-clean' === 'fashion-editorial' || 'skincare-clean' === 'minimalist') {
