...
export default function StoreCustomerAuthTechMinimal({ primaryColor, themeStyle, isKm }: { primaryColor: string, themeStyle: string, isKm: boolean }) {
      ...
      <div className="space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            ...
            style={'tech-minimal' !== 'neo-brutalism' ? { backgroundColor: primaryColor || '#000' } : undefined}
          >
