...
export default function StorefrontViewSkincareClean({ 
  params, 
  categorySlug, 
  viewMode = 'home',
  initialProducts,
  ...
  const getCategoryClass = (isActive: boolean) => {
    ...
    } else if ('skincare-clean' === 'minimalist') {
  ...
  const getCategoryPillClass = (isActive: boolean) => {
    if ('skincare-clean' === 'fashion-editorial' || 'skincare-clean' === 'minimalist') {
