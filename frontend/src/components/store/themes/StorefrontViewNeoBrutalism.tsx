...
export default function StorefrontViewNeoBrutalism({ 
  params, 
  categorySlug, 
  viewMode = 'home',
  initialProducts,
  ...
  const getCategoryClass = (isActive: boolean) => {
    ...
    } else if ('neo-brutalism' === 'minimalist') {
  ...
  const getCategoryPillClass = (isActive: boolean) => {
    if ('neo-brutalism' === 'fashion-editorial' || 'neo-brutalism' === 'minimalist') {
