 ...
 return (
  <div className="space-y-6 max-w-5xl mx-auto">
   ...
   {loading ? (
    ...
    <div className="bg-white dark:bg-[#121212] dark:border dark:border-white/10 rounded-none shadow-[0_18px_40px_rgba(112,144,176,0.12)] dark:shadow-none border border-none border-none overflow-hidden">
     <table className="min-w-full divide-y divide-[#F4F7FE] dark:divide-white/10">
      <thead className="bg-[#F4F7FE] dark:bg-[#000000]">
       <tr>
        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Plan Name</th>
        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Price (USD)</th>
        ...
        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Limits</th>
      ...
      <tbody className="divide-y divide-[#F4F7FE] dark:divide-white/10">
       {plans.map((plan) => (
        <tr key={plan._id} className="hover:bg-[#F4F7FE] dark:hover:bg-gray-800/50 transition-colors">
         ...
         <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-[#a1a1aa] dark:text-gray-300 font-medium">${plan.price}</td>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
       ...
       <div className="mt-8 flex justify-end space-x-3">
        <button
         ...
         className="px-5 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:text-[#fafafa] dark:hover:text-white font-medium"
        >
         Cancel
        </button>
        <button
         type="submit"
         className="px-5 py-2 bg-[#E84C3D] text-white rounded-none font-medium hover:bg-red-600 transition-colors shadow-[0_18px_40px_rgba(112,144,176,0.12)] dark:shadow-none"
        >
         Save Changes
        </button>
       </div>
