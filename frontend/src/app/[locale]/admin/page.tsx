        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white dark:bg-[#111111] rounded-2xl p-6 shadow-[0_18px_40px_rgba(112,144,176,0.12)] dark:shadow-none border-none relative overflow-hidden group">
              ...
              <div className="relative">
                <div className="flex justify-between items-start mb-4">
                  <div className="p-3 bg-green-50 dark:bg-green-900/20 text-green-500 rounded-xl shadow-sm border border-green-100 dark:border-green-900/30">
            ...
            <div className="bg-white dark:bg-[#111111] rounded-2xl p-6 shadow-[0_18px_40px_rgba(112,144,176,0.12)] dark:shadow-none border-none relative overflow-hidden group">
              ...
              <div className="relative">
                <div className="flex justify-between items-start mb-4">
                  <div className="p-3 bg-blue-50 dark:bg-blue-900/20 text-blue-500 rounded-xl shadow-sm border border-blue-100 dark:border-blue-900/30">
            ...
            <div className="bg-white dark:bg-[#111111] rounded-2xl p-6 shadow-[0_18px_40px_rgba(112,144,176,0.12)] dark:shadow-none border-none relative overflow-hidden group">
              ...
              <div className="relative">
                <div className="flex justify-between items-start mb-4">
                  <div className="p-3 bg-orange-50 dark:bg-orange-900/20 text-orange-500 rounded-xl shadow-sm border border-orange-100 dark:border-orange-900/30">
            ...
            <div className="bg-white dark:bg-[#111111] rounded-2xl p-6 shadow-[0_18px_40px_rgba(112,144,176,0.12)] dark:shadow-none border-none relative overflow-hidden group">
              ...
              <div className="relative">
                <div className="flex justify-between items-start mb-4">
                  <div className="p-3 bg-purple-50 dark:bg-purple-900/20 text-purple-500 rounded-xl shadow-sm border border-purple-100 dark:border-purple-900/30">
