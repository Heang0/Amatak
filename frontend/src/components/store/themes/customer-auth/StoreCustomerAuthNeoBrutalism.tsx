...
export default function StoreCustomerAuthNeoBrutalism({ primaryColor, themeStyle, isKm }: { primaryColor: string, themeStyle: string, isKm: boolean }) {
      ...
      <div className="space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            ...
            style={'neo-brutalism' !== 'neo-brutalism' ? { backgroundColor: primaryColor || '#000' } : undefined}
          >
