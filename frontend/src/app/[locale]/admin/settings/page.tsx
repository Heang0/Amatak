...
export default function AdminSettings() {
 ...
 <>
  ...
  {activeTab === 'profile' && (
   ...
   <div className="pt-4 border-t border-none border-none flex items-center space-x-4">
    <button
    type="submit"
  ...
  {activeTab === 'theme' && (
   ...
   <form onSubmit={handleStoreSubmit} className="space-y-6">
    ...
    <div className="pt-6 border-t border-none border-none flex justify-end">
    <button
     type="submit"
     disabled={loading || uploading}
     className="bg-[#E84C3D] text-white px-6 py-2.5 rounded-none font-medium hover:bg-red-600 transition-colors shadow-[0_18px_40px_rgba(112,144,176,0.12)] dark:shadow-none disabled:opacity-50 flex items-center gap-2"
    >
     {loading ? (
